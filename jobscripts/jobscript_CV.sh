...
#SBATCH -t 64:59:59          # how long time it will take to run
...
python -u run_CV_LILAC.py --batchsize 16 --seed 20 \
    --run_name 'CV_w_age_w_dropout_w_MLP' --lr 0.0001 \
    --optional_meta sex_M sex_F age \
    --dropout 0.2 \
    --max_epoch 50