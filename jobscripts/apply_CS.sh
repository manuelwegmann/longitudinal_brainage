...
python -u apply_CS_CNN.py --json /mimer/NOBACKUP/groups/brainage/thesis_brainage/results/CS_CI_final/run_details.json \
    --participants_file /mimer/NOBACKUP/groups/brainage/thesis_brainage/CI_CN_groups/CI_participants.csv \
    --model_state /mimer/NOBACKUP/groups/brainage/thesis_brainage/results/CS_CI_final/model.pt
