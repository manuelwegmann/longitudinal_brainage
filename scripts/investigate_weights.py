...
# Set paths
path_to_json = '/mimer/NOBACKUP/groups/brainage/thesis_brainage/results/5-fold-cv_wo_age/run_details.json'
path_to_best_model = '/mimer/NOBACKUP/groups/brainage/thesis_brainage/results/5-fold-cv_wo_age/5-fold-cv_wo_age/fold_1/best_model.pt'
...
print(f"Number of features in fully connected layer: {len(fc_weights)}")
