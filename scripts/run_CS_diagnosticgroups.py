...
def parse_args():
    ...
    parser.add_argument('--CI_comparison', default='yes', type=str, help="change to yes if plan is to run model for comparison between CN and CI")
...
if __name__ == "__main__":
    ...
    if opt.CI_comparison == 'yes':
        ...
        train_fold = pd.read_csv('/mimer/NOBACKUP/groups/brainage/thesis_brainage/CI_CN_groups/CS_CN_training_for_CI.csv')
